...
<body>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <form method="POST" action="addprojectfunc.php">    
                    <div class="form-group">
                        <input type="text" class="form-control" name="title" placeholder="Enter SAD Project Title">
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" name="grp" placeholder="Group Number">
                        </div>
                    </div>
                    <br>
                    <textarea class="form-control" style="resize:none" rows="4" cols="120" name="abstract"
                        placeholder="Enter SAD Project Abstract.."></textarea>
                    <br>
                    <textarea class="form-control" style="resize:none" rows="4" cols="120" name="objectives"
                        placeholder="Enter SAD Project Objectives.."></textarea>
                    <br>
                    <textarea class="form-control" style="resize:none" rows="4" cols="120" name="scope" 
                        placeholder="Enter SAD Project Scope of the study.."></textarea>
                    <br>
                    <textarea class="form-control" style="resize:none" rows="4" cols="120" name="purpose"
                        placeholder="Enter SAD Project Purpose of the study.."></textarea>

                    <input type="hidden" name="projno">
                                        
                                        <div class="card-footer text-center">
                    <input class="btn btn-outline-dark" type="submit" value="Add Record">
</div>
    ...
    ================================================== -->
                ...
                <script src="jquery/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo"
