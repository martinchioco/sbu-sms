...
INSERT INTO `acc_info` (`account_id`,`user`, `pass`, `acctype`,`adviser`) VALUES
('1','1a-2018', 'ed2b1f468c5f915f3f1cf75d7068baae', 'student',''),
('2','admin', '21232f297a57a5a743894a0e4a801fc3', 'administrator',''),
('3','student', 'cd73502828457d15655bbd7a63fb0bc8', 'student','');
...
--
ALTER TABLE `projects`
  MODIFY `projno` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `projinfo`
--
ALTER TABLE `projinfo`
  MODIFY `projno` int(89) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
